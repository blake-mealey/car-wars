...
Mesh* ContentManager::HaveMesh(const string filePath) {
...
Component* ContentManager::LoadComponent(json data) {
    ...
    if (type == "Mesh") component = new MeshComponent(data);
		...
		//component = new MeshComponent(data);//HeightMapComponent(data);
		Mesh* mesh = nullptr;
		HeightMap::CreateMesh(mesh, data);
		component = new MeshComponent(mesh, data);
	}
	...
	else if (type == "RigidHeight") {
		Mesh* mesh = nullptr;
		HeightMap::CreateMesh(mesh, data);
		component = new RigidStaticComponent(mesh, data);
	}
